...
function cadastrarUsuario(req, res) {
  ...
  empresaService
    .cadastrarUsuario(nomeUsuario, emailUsuario, senhaUsuario, fkEmpresa)
...
function deleteUsuario(req, res) {
  ...
  empresaService
    .deleteUsuario(idUsuario, idEmpresa)
    .then(function (resultado) {
...
function atualizarEmailEmpresa(req, res) {
  ...
  empresaService
    .atualizarEmailEmpresa(id, email)
    .then(function (resultado) {
      if (resultado.affectedRows == 0) {
        return res.json({ message: "empresa não encontrada" });
      }
...
function atualizarSenhaEmpresa(req, res) {
  ...
  empresaService
    .atualizarSenhaEmpresa(id, senhaAtual, senhaNova)
    .then(function (resultado) {
...
function atualizarUsuarioEmpresa(req, res) {
  ...
  empresaService
    .atualizarUsuarioEmpresa(idUsuario, idEmpresa, nome, email, senha)
    .then(function (resultado) {
      if (resultado.affectedRows == 0) {
