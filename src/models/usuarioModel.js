...
function autenticar(email, senha) {
  ...
  var instrucaoSql = `
        SELECT id, nome, email, fkEmpresa as empresaId, perfil, atividade FROM usuario WHERE email = '${email}' AND senha = '${senha}';
    `;
...
function retornaTodosOsUsuariosDaEmpresa(id, fkEmpresa) {
  ...
  console.log(
    "Executando a instrução SQL (retornar todos os usuários da empresa): \n" +
