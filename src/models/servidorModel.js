...
function cadastrarServidor(nomeServidor, sistemaOperacional, macAddress, tipoServidor, modelo, serviceTag, fkEmpresa) {
    let instrucaoSql = `
    ...
    `;
    console.log("Executando a instrução SQL (cadastro de servidor): \n" + instrucaoSql);
...
function cadastrarComponentes(nomeComponente, unidade_medida) {
    ...
    `;
    console.log("Executando a instrução SQL (cadastro componentes): \n" + instrucaoSql);
    return database.executar(instrucaoSql);
}
...
function cadastrarParametro(fkServidor, fkComponente, alerta_min, alerta_max) {
    ...
    `;
    console.log("Executando a instrução SQL (cadastro parametro): \n" + instrucaoSql);
    return database.executar(instrucaoSql);
}
